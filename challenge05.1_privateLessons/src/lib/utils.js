...
function graduation(education_level) {
    let formation = ""
...
function checkEmptyFields(currentUser){
...
function ArraysTeachers(_teachers){
    const teachers = []
...
function ArraysStudents(_students){
    const students = []
